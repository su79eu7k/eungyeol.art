      ...
      <section id='one'>
        <StyledBio>
          <Fade In duration={3000} cascade>
            <div>
              <p>
                우리 오빠는 안동사범을, 거기서도 최우수 그룹으로 나온, 어머니께는 거의 우상. <br />아들로서는 완벽한 존재였던 것 같다. 물론 내게도 특별한 분이고.
              </p>
            </div>
          </Fade>
        </StyledBio>
      ...
      <section id='two'>
        <StyledBio>
          <Fade In duration={3000} cascade>
            <div>
              <p>
                제대 후에 시골에 발령을 받았는데, 내가 6학년 때였어. <br />평소 진정한 시골을 그리던 나는, 부모님을 졸라서 오빠를 따라 그 분교로 전학을 갔어. <br />남들은 6학년이라고 중학교 입시준비 공부 한다고 야단인데.
              </p>
            </div>
          </Fade>
        </StyledBio>
      ...
      <section id='three'>
        <StyledBio>
          <Fade In duration={3000} cascade>
            <div>
              <p>
                난생 처음 버스를 타고 먼지 나는 길을 두어 시간 달려서 군위에서 내렸다. <br />내를 건너고 산길을 걷고 걸어 진정한 시골 그곳에 도착했는데, <br />도중에 옹달샘에서 쉬고 물도 마셨지. 정말 좋았어.
              </p>
            </div>
          </Fade>
        </StyledBio>
